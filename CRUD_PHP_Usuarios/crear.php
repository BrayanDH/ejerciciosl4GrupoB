            ...
            <div class="col-sm-6 offset-3">
                <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="telefono" placeholder="Ingresa el telefono">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary w-100" name="crear-registro">Crear Registro</button>
