...
<body>
    ...
    <p class="text-center">Aprende a realizar operaciones básicas entre PHP y
         una base de datos, en este caso MySQL: CRUD(Create, Read, Update, Delete)</p>
